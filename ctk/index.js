...
var DefaultURL = "${APIDEFAULTURL}/tmf-api/serviceOrdering/v4/";
var schema;
var hostname;
var port;
...
function getURL(){
    ...
    'https://apictk-service-ordering-v4-0-0.mybluemix.net/tmf-api/serviceOrdering/v4/serviceOrder\n'+
    'becomes\n'+
    'https://apictk-service-ordering-v4-0-0.mybluemix.net/tmf-api/serviceOrdering/v4\n>', (answer) => {
    DefaultURL = answer;
    rl.close();
    isURLValid(answer);
