...
var DefaultURL = "${APIDEFAULTURL}/tmf-api/serviceOrdering/v3/";
var schema;
var hostname;
var port;
...
console.log("////////////////////////////////////////////////////////////////////////\nWelcome to the Conformance Test Kit for TMF641 ServiceOrdering R18 5\n");
getURL();
...
function getURL(){
    ...
    'https://apictk-service-ordering-v3-0-0.mybluemix.net/tmf-api/serviceOrdering/v3/serviceOrder\n'+
    'becomes\n'+
    'https://apictk-service-ordering-v3-0-0.mybluemix.net/tmf-api/serviceOrdering/v3\n>', (answer) => {
    DefaultURL = answer;
    rl.close();
    isURLValid(answer);
...
function exportEnvironment(url){
    ...
    envJson.values.forEach(element => {
        if (element.key == "ServiceOrderingAPI"){
            element.value = url;
        }
    });
...
function runNewman(){
    ...
    newman.run({
        collection: require('./CTK-TMF641-ServiceOrdering-R18-5.postman_collection.json'),
